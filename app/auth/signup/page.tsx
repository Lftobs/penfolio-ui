      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-white dark:bg-zinc-800 rounded-3xl p-8 shadow-sm">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-light mb-2 dark:text-white">Create account</h1>
            <p className="text-zinc-500 dark:text-zinc-400">Join PenFolio and start writing</p>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-zinc-500 dark:text-zinc-400">
              ...
              <Link href="/auth/signin" className="text-black dark:text-white hover:underline font-medium">
                Sign in
              </Link>
            </p>
          </div>
